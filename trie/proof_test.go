...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *memdb.MemDatabase {
	var provers []func(key []byte) *memdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *memdb.MemDatabase {
		proof := memdb.New()
