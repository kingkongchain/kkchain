...
// Used for testing
func newEmpty() *Trie {
	trie, _ := New(common.Hash{}, NewDatabase(memdb.New()))
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	trie, err := New(common.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), NewDatabase(memdb.New()))
	if trie != nil {
...
func benchGet(b *testing.B, commit bool) {
	...
	if commit {
		rdb := trie.db.diskdb.(*rocksdb.RDBDatabase)
		rdb.Close()
		os.RemoveAll(rdb.Path())
	}
}
...
func tempDB() (string, *Database) {
	...
	diskdb, err := rocksdb.New(dir, nil)
	if err != nil {
